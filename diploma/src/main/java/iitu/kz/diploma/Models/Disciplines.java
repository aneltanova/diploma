...
public class Disciplines {
    ...
    @Column(name = "lecture_hours", nullable = false, columnDefinition = "BIGINT")
    private long lecture_hours;

    @Column(name = "practice_hours", nullable = false, columnDefinition = "BIGINT")
    private long practice_hours;

    @Column(name = "laboratory_hours", nullable = false, columnDefinition = "BIGINT")
    private long laboratory_hours;

    @Column(name = "SIS", nullable = false, columnDefinition = "BIGINT")
    private long sis;

    @Column(name = "credits", nullable = false, columnDefinition = "BIGINT")
